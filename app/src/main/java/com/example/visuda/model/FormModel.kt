...
val formPermintaanSuratDomisiliConfig = FormConfig(
    fields = listOf(
...
val formPermintaanSuratKeteranganNikahConfig = FormConfig(
    fields = listOf(
        FormField("Nama Lengkap", "Masukkan Nama Lengkap", InputType.TEXT),
        FormField("NIK", "Masukkan NIK", InputType.NUMBER),
        FormField("Jenis Kelamin", "Pilih Jenis Kelamin", InputType.DROPDOWN),
...
val formPermintaanSuratPengantarRTRWConfig = FormConfig(
    fields = listOf(
        FormField("Nama Lengkap", "Masukkan Nama Lengkap", InputType.TEXT),
        FormField("NIK", "Masukkan NIK", InputType.NUMBER),
        FormField("Jenis Kelamin", "Pilih Jenis Kelamin", InputType.DROPDOWN),
...
val formPermintaanSuratPembuatanKKConfig = FormConfig(
    fields = listOf(
        FormField("Nama Lengkap", "Masukkan Nama Lengkap", InputType.TEXT),
...
val formPermintaanSuratKeteranganUsahaConfig = FormConfig(
    fields = listOf(
        FormField("Nama Lengkap", "Masukkan Nama Lengkap", InputType.TEXT),
        FormField("NIK", "Masukkan NIK", InputType.NUMBER),
        FormField("Jenis Kelamin", "Pilih Jenis Kelamin", InputType.DROPDOWN),
...
val formPermintaanSuratKeteranganKematianConfig = FormConfig(
    fields = listOf(
        FormField("Nama Lengkap", "Masukkan Nama Lengkap", InputType.TEXT),
